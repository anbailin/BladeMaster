...
//======================================================================================
//======================================================================================
HRESULT WINAPI DXUTCreateDevice(bool bWindowed, int nSuggestedWidth, int nSuggestedHeight, DXUTDeviceVersion ver) {
    HRESULT hr = S_OK;
    ...
    deviceSettings.MinimumFeatureLevel = D3D_FEATURE_LEVEL_9_3;
