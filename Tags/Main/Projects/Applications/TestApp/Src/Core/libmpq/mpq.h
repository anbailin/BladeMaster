...
#pragma pack(pop)
	...
	char *libmpq_version();
	extern "C" CORE_DLL int libmpq_archive_open(mpq_archive *mpq_a, unsigned char *mpq_filename);
	extern "C" CORE_DLL int libmpq_archive_close(mpq_archive *mpq_a);
	extern "C" CORE_DLL int libmpq_archive_info(mpq_archive *mpq_a, unsigned int infotype);
	//int libmpq_file_extract(mpq_archive *mpq_a, const int number);\
	/// *dest must have enough space
	extern "C" CORE_DLL int libmpq_file_getdata(mpq_archive *mpq_a, const int number, unsigned char *dest);
	extern "C" CORE_DLL int libmpq_file_info(mpq_archive *mpq_a, unsigned int infotype, const int number);
	extern "C" CORE_DLL int libmpq_file_number(mpq_archive *mpq_a, const char *name);
	extern "C" CORE_DLL int libmpq_file_number_from_hash(mpq_archive *mpq_a, unsigned int hash1, unsigned int hash2);
	extern "C" CORE_DLL int libmpq_file_check(mpq_archive *mpq_a, void *file, int type);
	extern "C" CORE_DLL int libmpq_hash_filename(mpq_archive *mpq_a, const unsigned char *pbKey, unsigned int *seed1, unsigned int*seed2);

	extern "C" CORE_DLL int libmpq_pkzip_decompress(char *out_buf, int *out_length, char *in_buf, int in_length);
	extern "C" CORE_DLL int libmpq_zlib_decompress(char *out_buf, int *out_length, char *in_buf, int in_length);
	extern "C" CORE_DLL int libmpq_huff_decompress(char *out_buf, int *out_length, char *in_buf, int in_length);
	extern "C" CORE_DLL int libmpq_wave_decompress_stereo(char *out_buf, int *out_length, char *in_buf, int in_length);
	extern "C" CORE_DLL int libmpq_wave_decompress_mono(char *out_buf, int *out_length, char *in_buf, int in_length);
	extern "C" CORE_DLL int libmpq_multi_decompress(char *out_buf, int *pout_length, char *in_buf, int in_length);
