...
//--------------------------------------------------------------------------------------
class RENDER_DLL CFirstPersonCamera : public CBaseCamera
{
public:
    CFirstPersonCamera();
...
//--------------------------------------------------------------------------------------
class RENDER_DLL CModelViewerCamera : public CBaseCamera
{
public:
    CModelViewerCamera();
...
//--------------------------------------------------------------------------------------
RENDER_DLL void DXUTDisplaySwitchingToREFWarning();
